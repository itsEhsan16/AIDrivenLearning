...
import { clearRoadmapCache } from "@/lib/utils";
...
export const RoadmapDisplay = ({
  ...
  const handleClearCache = () => {
    clearRoadmapCache(userGoals);
    setError("Cache cleared! Generating a fresh roadmap...");
    setTimeout(() => {
      generateRoadmap();
    }, 1000);
  };
  ...
  const weeklyTasks = roadmap.tasks.reduce(
    (acc, task) => {
  ...
  const weekNumbers = Object.keys(weeklyTasks)
    .map(Number)
    .sort((a, b) => a - b);
  ...
  const weekCompletedTasks = selectedWeekTasks.filter(
    (t) => t.completed,
  ).length;
  const weekProgress = weekTotalTasks
    ...
    <>
      ...
      <div className="text-center mb-2 md:hidden">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          AI has crafted a personalized learning journey based on your goals and
          preferences
        </p>
      </div>
      <motion.div
      ...
      >
          ...
          <Card className="glass border-white/10 sticky top-24 w-full">
            ...
            <CardContent>
              ...
              <Button
                onClick={onBack}
                variant="outline"
                className="mt-8 w-full border-white/20"
              >
        ...
        <main className="flex-1 w-full">
          ...
          <div className="text-center mb-2 hidden md:block">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              AI has crafted a personalized learning journey based on your goals
              and preferences
            </p>
          </div>
          <Card className="glass border-white/10 w-full">
            ...
            <CardContent>
              ...
              <Button
                ...
                variant="outline"
                className="w-full border-white/20 mt-3 text-sm"
              >
                <Trash2 className="mr-2 w-4 h-4" /> Clear Cache & Regenerate
              </Button>
            </CardContent>
          </Card>
